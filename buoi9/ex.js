...
// let n = Number(prompt('Hãy nhập ID bất kỳ: '));
...
// if (isExistUser === false) {
	// alert('Không có người dùng nào tồn tại');
// }
...
// function getEmailsByKeyword(keyword) {
    ...
    // ).map(user => user.email);
// }
// console.log(getEmailsByKeyword('Davenall'));
...
// for (let age of users) {
	...
	// }
// }
// console.log('Số lượng user có tuổi trên 50 là: ', count);
